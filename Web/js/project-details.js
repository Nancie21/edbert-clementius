  ...
  const PROJECTS = {
    ...
    proj2: {
      ...
      screenshots: [
        "images/main-bg.jpg",
        "images/main-bg.jpg",
        "/skillsync-course-module-interface.jpg",
        "/skillsync-progress-dashboard.jpg",
      ],
    ...
    proj3: {
      ...
      downloadUrl: "#",
      screenshots: [
        "images/RUindows square 2.jpg",
        "/ruindows-file-browser-interface.jpg",
        "/ruindows-notepad-application.jpg",
        "/ruindows-desktop-environment.jpg",
      ],
